...
const img1 = "https://psbfhomirpzlkinuttea.supabase.co/storage/v1/object/public/blog-images/father_daughter_1.png";
const img2 = "https://psbfhomirpzlkinuttea.supabase.co/storage/v1/object/public/blog-images/father_daughter_2.png";
const img3 = "https://psbfhomirpzlkinuttea.supabase.co/storage/v1/object/public/blog-images/father_daughter_3.png";
const img4 = "https://psbfhomirpzlkinuttea.supabase.co/storage/v1/object/public/blog-images/father_daughter_4.png";
const img5 = "https://psbfhomirpzlkinuttea.supabase.co/storage/v1/object/public/blog-images/father_daughter_5.png";
const img6 = "https://psbfhomirpzlkinuttea.supabase.co/storage/v1/object/public/blog-images/father_daughter_6.png";
const img7 = "https://psbfhomirpzlkinuttea.supabase.co/storage/v1/object/public/blog-images/father_daughter_7.png";
const img8 = "https://psbfhomirpzlkinuttea.supabase.co/storage/v1/object/public/blog-images/father_daughter_8.png";
const img9 = "https://psbfhomirpzlkinuttea.supabase.co/storage/v1/object/public/blog-images/father_daughter_9.png";

const blogHtml = `<p class="lead text-lg font-serif italic mb-6">A little over a year ago, the New York City art dealer Robert Rogal received a visit to his private showroom from a young woman, who seemed eager to offload a family heirloom.</p>

<div class="my-8 rounded-[24px] overflow-hidden border border-offwhite/50 shadow-md">
  <img src="${img1}" alt="Forged Raimonds Staprans / Andrew Wyeth landscape style painting" class="w-full h-auto object-cover max-h-[550px]" />
...
<div class="my-8 rounded-[24px] overflow-hidden border border-offwhite/50 shadow-md">
  <img src="${img2}" alt="Portrait of Elisabeth Lederer by Gustav Klimt" class="w-full h-auto object-cover max-h-[650px]" />
...
<div class="my-8 rounded-[24px] overflow-hidden border border-offwhite/50 shadow-md">
  <img src="${img3}" alt="Elisabeth's mother Szerena in her apartment in Vienna with the portrait" class="w-full h-auto object-cover max-h-[500px]" />
...
<div class="my-8 rounded-[24px] overflow-hidden border border-offwhite/50 shadow-md">
  <img src="${img4}" alt="Klimt in 1914" class="w-full h-auto object-cover max-h-[500px]" />
...
<div class="my-8 rounded-[24px] overflow-hidden border border-offwhite/50 shadow-md">
  <img src="${img5}" alt="Arnold Böcklin - Self-Portrait with Death Playing the Fiddle" class="w-full h-auto object-cover max-h-[550px]" />
...
<div class="my-8 rounded-[24px] overflow-hidden border border-offwhite/50 shadow-md">
  <img src="${img6}" alt="Octagonal Renaissance/Devotional Masterpiece" class="w-full h-auto object-cover max-h-[550px]" />
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
  <div class="rounded-[24px] overflow-hidden border border-offwhite/50 shadow-md bg-white">
    <img src="${img7}" alt="Descartes Model: Subject to Object" class="w-full h-auto object-contain max-h-[300px] p-4" />
  ...
  <div class="rounded-[24px] overflow-hidden border border-offwhite/50 shadow-md bg-white">
    <img src="${img8}" alt="Baudrillard Model: Object to Subject" class="w-full h-auto object-contain max-h-[300px] p-4" />
...
<div class="my-8 rounded-[24px] overflow-hidden border border-offwhite/50 shadow-md">
  <img src="${img9}" alt="Distorted faces surreal collage" class="w-full h-auto object-cover max-h-[550px]" />
...
async function updateDatabase() {
  ...
  // 1. Delete duplicate row if exists
  const { error: delErr } = await supabase
    .from('blog_submissions')
    .delete()
    .eq('id', duplicateId);
  if (delErr) console.warn('Duplicate row delete note:', delErr.message);
  else console.log('Deleted duplicate row:', duplicateId);

  // 2. Update primary row with full HTML content, older published_at date, approved status
  const publishedDate = '2026-03-15T12:00:00.000Z'; // Set as previous/older blog than Prajakta Potnis (2026-04-12)
  ...
  if (upErr) {
    console.error('Failed to update primary blog:', upErr);
  } else {
    console.log('Successfully updated blog in database with ID:', primaryId);
  }
}
