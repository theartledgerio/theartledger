                ...
                >
                  ...
                  <div className="md:col-span-5 overflow-hidden relative min-h-[300px] md:min-h-[380px]">
                    ...
                    <div className="absolute top-4 left-4 z-10">
                      <span className="inline-block px-3 py-1 bg-midnight/90 backdrop-blur-md text-white text-[9px] font-mono uppercase tracking-widest rounded-full font-bold shadow-sm">
                        {blog.category}
                      </span>
                    </div>
                    {/* Subtle paper luster overlay */}
